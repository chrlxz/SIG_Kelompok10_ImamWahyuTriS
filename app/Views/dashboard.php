...
<div id="map" class="flex-grow" style="width: 1200px;height: 
750px;"></div>
...
const geojson = new L.geoJson(kecamatan,{style:style, // warna polygon kuning
...
<tbody id="tableBody">
<tr>
    <td>Kabupaten</td><td>:</td><td>KULON PROGO</td>
</tr>
<tr>
    <td>Luas Wilayah</td><td>:</td><td> 586,27 km²<sup></sup></td>
</tr>
<tr>
<td>Jumlah Penduduk</td><td>:</td><td> 446.019 Jiwa </td>
</tr>
</tbody>
</table>
</div>
<div class="card-footer small">Sumber : BPS 2022</div>
</div>
</div>
</div>
</main>
<?php echo view('footer'); // memanggil file view footer.php
?>